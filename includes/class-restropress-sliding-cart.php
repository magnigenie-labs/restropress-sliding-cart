 ...
 * @subpackage Restropress_Sliding_Cart/includes
 */
class Restropress_Sliding_Cart {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Restropress_Sliding_Cart_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'RESTROPRESS_SLIDING_CART_VERSION' ) ) {
			$this->version = RESTROPRESS_SLIDING_CART_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Restropress_Sliding_Cart_Loader. Orchestrates the hooks of the plugin.
	 * - Restropress_Sliding_Cart_i18n. Defines internationalization functionality.
	 * - Restropress_Sliding_Cart_Admin. Defines all hooks for the admin area.
	 * - Restropress_Sliding_Cart_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		$this->loader = new Restropress_Sliding_Cart_Loader();
	 ...
	 *
	 * Uses the Restropress_Sliding_Cart_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Restropress_Sliding_Cart_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Restropress_Sliding_Cart_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Restropress_Sliding_Cart_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Restropress_Sliding_Cart_Loader    Orchestrates the hooks of the plugin.
	 */
